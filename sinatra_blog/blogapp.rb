...
blog = Blog.new
blog.add_post Post.new("First Post", Time.new(2016,1 ,1), "about me", "jonathan Aumann", "this is my first post im pretty confident it will post")
blog.add_post Post.new("third", Time.new(2016, 3, 15),"about me", "jonathan Aumann", "This is my third and last post counted")
blog.add_post Post.new("wassup", Time.new(2016, 3, 16),"about me", "jonathan Aumann", "This is 5th and last post for awhile")
...
post "/create_post" do
  ...
  new_post = Post.new( params[:title], Time.now, params[:catagory], params[:author], params[:text] )
